...
GI final
 ...
 master
@A9Aru
A9Aru committed 32 minutes ago 
1 parent f6732d7 commit 3b553bfb0411d8c3cbc893d820d6c28f282f7ab7
Showing  with 548 additions and 0 deletions.
 548  ZankyoFinalFinal.py 
@@ -0,0 +1,548 @@
from tkinter import *
...
playground = Listbox(masterFrame, bg = '#DCEDC2', fg = "#000000",width = 80, bd = 5, selectbackground = "#A8E6CE", selectforeground = "#ffffff")
